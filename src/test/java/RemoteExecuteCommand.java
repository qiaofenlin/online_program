...
//如果为得到标准输出为空，说明脚本执行出错了
    ...
    public static void main(String[] args) {
        RemoteExecuteCommand rec=new RemoteExecuteCommand("47.93.221.91", "root","Qq111111");
//        RemoteExecuteCommand rec=new RemoteExecuteCommand("192.168.1.153", "root","123456");
//执行命令
